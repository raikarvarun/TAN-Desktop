...
namespace TAN.Views
{
    ...
    /// </summary>
    public partial class PaymentInPageVIew : UserControl
    {
        ...
        public PaymentInPageVIew(IEventAggregator events, IAPIHelper aPIHelper, bool hideorUnhide)
        {
            InitializeComponent();
            _events = events;
            _apiHelper = aPIHelper;
            var tem = OrderTableSqlite.getInvoiceNo(3);
